...
$req = 'select content from pages where title = "diplomes_acc" and section = "title"';
...
<section style="text-align:center;"><br><br>

<h1>Architecture des formations et diplomes</h1>
    <img src="images/architecture.png" alt="" width="80%" style="margin-bottom:0px;margin-top:20px;">
</section>

    <section id="course">
    <?php

$req = 'select content from pages where title = "diplomes_acc" and section = "section1"';
$res = mysqli_query($link, $req);
...
$req = 'select * from formations where type="acc"';
$res = mysqli_query($link, $req);
...
if (mysqli_num_rows($res) == 0) {
    ...
    while ($row = mysqli_fetch_array($res, MYSQLI_ASSOC)) {
        echo'<div onclick="window.location.href=\'formation-page.php?id='.$row['id'].'\'" class="courses">
