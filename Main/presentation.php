    ...
    <nav>
        ...
        <div class="navigation">
            <ul>
                ...
                <li><a href="Presentation.php" class="active">Presentation</a></li>
...
$req = 'select content from pages where title = "presentation" and section = "title"';
...
$req = 'select content from pages where title = "presentation" and section = "section1"';
$res = mysqli_query($link, $req);
...
$req = 'select content from pages where title = "presentation" and section = "section2"';
$res = mysqli_query($link, $req);
