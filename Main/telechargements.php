...
<body>
    ...
    <section id="pres-home">
        <h2>Telechargements</h2>
    </section>
    
    <section class="tele-container">
        <h2>Guide generale</h2>
        <br><br>
        <div class="tele">
            <i class="fa-solid fa-file-pdf"></i>
            <p>Guide generale</p>
            <a href="Images/3GI.pdf" download="file" class="blue"><i class="fa-solid fa-download"></i></a>
            <a href="Images/3GI.pdf" target="_blank" class="orange"><i class="fa-solid fa-book-open"></i></a>
        </div>
        <br><br>
        <h2>Guides des formations</h2>
        <br><br>
        <div class="tele">
            <i class="fa-solid fa-file-pdf"></i>
            <p>Bac + 5 Genie Info</p>
            <a href="Images/3GI.pdf" download="file" class="blue"><i class="fa-solid fa-download"></i></a>
            <a href="Images/3GI.pdf" target="_blank" class="orange"><i class="fa-solid fa-book-open"></i></a>
        </div>
        <div class="tele">
