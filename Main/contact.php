...
$req = 'select content from pages where title = "contact" and section = "title"';
...
$req = 'select content from pages where title = "contact" and section = "section1"';
$res = mysqli_query($link, $req);
...
if (mysqli_num_rows($res) == 0) {
    ...
    <p>'.$content['text'].'</p>
    <div class="getin-det">
        <h3>'.$content['adr_titre'].'</h3>
        <div>
            <i class="fa-solid fa-location-dot get"></i>
            <p>'.$content['adr_text'].'</p>
        </div>
        <h3>'.$content['phone_titre'].'</h3>
        <div>
            <i class="fa-solid fa-phone get"></i>
            <p> '.$content['phone_nbr'][0].' <br> '.$content['phone_nbr'][1].'</p>
        </div>
        <h3>'.$content['sup_titre'].'</h3>
        <div>
            <i class="fa-solid fa-at get"></i>
            <p>'.$content['email'].'</p>
        </div>
...
$req = 'select content from pages where title = "contact" and section = "section2"';
$res = mysqli_query($link, $req);
...
echo '<div class="form">
            ...
            <div class="form-col">
                <textarea name="" id="" cols="30" rows="8" placeholder="Comment pouvons vous aider?"></textarea>
            </div>
            <div class="form-col">
...
?>
    ...
    <section id="map">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d2856.187541308908!2d-8.007120163865808!3d31.64484047418251!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xdafee873bf156df%3A0x86dc138c4b697368!2sESMA!5e0!3m2!1sfr!2sma!4v1656901618895!5m2!1sfr!2sma" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </section>
