    ...
    <nav>
        ...
        <div class="navigation">
            <ul>
                ...
                <li><a href="formations-france.php" class="active">Diplomes d'etat Francais</a></li>
...
$req = 'select content from pages where title = "diplomes_fr" and section = "title"';
...
$req = 'select content from pages where title = "diplomes_fr" and section = "section1"';
$res = mysqli_query($link, $req);
